...
public class MatTipe4 : MonoBehaviour,IMiniGameSoal {

    [System.Serializable]
    public enum Stage /*!<menentukan stage (jenis soal)*/
    {
        stage_6
    }
    public Stage thisStage = Stage.stage_6; /*!<menentukan soal ini masuk ke stage berapa*/
    public ButtonImage leftSoal; /*!<button soal kiri*/
    public ButtonImage rightSoal; /*!<button soal kanan*/
    ...
    {   
        ...
        /*/
        int maxVal = 5;
        int leftNumber = RecursiveRandom(new int[1] {0}, 1, maxVal);
        leftSoal.initThisButton(this, false, leftNumber.ToString());
        int maxvalNew = 10 - leftNumber;
        int rightNumber = Random.Range(1, maxvalNew);
        rightSoal.initThisButton(this, false, rightNumber.ToString());
